...
import time
import datetime
import data_helpers2 as data_helpers2
...
# Data loading params
outpath = './results/result_C'+"/"+ result + "/" + test
if os.path.exists(outpath) == False:
    os.makedirs(outpath)
tf.flags.DEFINE_float("dev_sample_percentage", .1, "Percentage of the training data to use for validation")
tf.flags.DEFINE_string("train_data_file","./data"+"/"+train+"/"+"C.txt","Data for Training")
tf.flags.DEFINE_string("test_data_file","./data/Test_network/Test_Contingency/"+test+"/"+"dev"+"/"+test,"Data for Testing")
tf.flags.DEFINE_string("label","C",'label for train')
