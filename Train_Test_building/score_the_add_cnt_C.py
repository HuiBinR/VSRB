...
temp, a_contingency, b_expansion, result_num = sys.argv
a_contingency = float(a_contingency)
b_expansion = float(b_expansion)

dir_in = "/home/xzdong/rhb/Ding/part_add_c"
dir_out = "/home/xzdong/rhb/Ding/score_part_add_c"+"/"+str(a_contingency)+"_"+str(b_expansion)
if os.path.exists(dir_out) == False:
    os.makedirs(dir_out)

path_result = "/home/xzdong/rhb/Ding/c"+"/"+result_num
